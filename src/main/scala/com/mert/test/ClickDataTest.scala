...
class ClickDataTest  {
  ...
  def testGetUniqueProductViewCountsByProductId(): Unit = {
    ...
    assertEquals(Seq(("496",1)), ClickDataMain.getUniqueProductViewCountsByProductId())
  }
  ...
  def testGetAllEventsOfUserId47(): Unit = {
    ...
    assertEquals(Seq("add","view"), ClickDataMain.getAllEventsOfUserId47())
  }
  ...
  def testGetUniqueEventCounts(): Unit = {
    ...
    assertEquals(Seq(("add",2)), ClickDataMain.getUniqueEventCounts())
  }
  ...
  def testGetProductViewsOfUserId47(): Unit = {
    ...
    assertEquals(Seq("47"), ClickDataMain.getProductViewsOfUserId47())
  }
